...
class CIFAR10(DatasetBase):
    ...
    def download_load(self):
        dataset_train = datasets.CIFAR10(root="/home/lzj/datasets/cifar10", train=True, download=True)
        self.train_data = dataset_train.data
        self.train_label = np.array(dataset_train.targets)
        dataset_test = datasets.CIFAR10(root="/home/lzj/datasets/cifar10", train=False, download=True)
