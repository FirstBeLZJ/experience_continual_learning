...
class CIFAR100(DatasetBase):
    ...
    def download_load(self):
        dataset_train = datasets.CIFAR100(root="/home/lzj/datasets/cifar100", train=True, download=True)
        self.train_data = dataset_train.data
        self.train_label = np.array(dataset_train.targets)
        dataset_test = datasets.CIFAR100(root="/home/lzj/datasets/cifar100", train=False, download=True)
