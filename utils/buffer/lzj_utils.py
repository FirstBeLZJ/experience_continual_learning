...
def compute_topsis(model, eval_x, eval_y, cand_x, cand_y, device="cpu"):
    """
...
def sorted_cand_ind(eval_df, cand_df, n_eval, n_cand):
    ...
    # True为选远的
    sorted_cand_ind_ = distance_vector.argsort(descending=False)
